...
export function OpinionsContextProvider({ children }) {
  ...
  useEffect(() => {
    async function loadOpinions() {
      const response = await fetch(`${mailUrl}/opinions`);
  ...
  async function upvoteOpinion(id) {
    const response = await fetch(`${mailUrl}/opinions/${id}/upvote`, {
      method: "POST",
    });
  ...
  async function downvoteOpinion(id) {
    const response = await fetch(`${mailUrl}/opinions/${id}/downvote`, {
      method: "POST",
    });
